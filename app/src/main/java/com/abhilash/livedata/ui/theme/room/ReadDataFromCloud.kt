...
fun ReadDataFromCloud(navController: NavController) {
  ...
  Column {
      ...
      val databaseReference = FirebaseDatabase.getInstance("https://mydutydiary-default-rtdb.firebaseio.com/").getReference(penNumberInput?.takeIf { it.isNotEmpty() } ?: "123") // Replace "employees" with your node
